...
-- Nome do index
alter index equipe_pkey rename to pk_tipo_equipe;
-- Nome da sequência
...
-- Nome do index
alter index papel_pkey rename to pk_tipo_papel;
-- Nome da sequência
...
-- Nome do index
alter index pk_status rename to pk_tipo_status;
...
-- Nome do index
alter index valor_pkey rename to pk_tipo_valor;
-- Tabelas estrangeiras (nome da referência da foreign key e nome das colunas pertinentes)
