...
public interface EdocsWebClient {
	...
	GerarUrlUploadResponseDto gerarUrlUploadArquivo(@RequestHeader("Authorization") String authToken,
			@PathVariable Long tamanhoArquivoEmBytes);
	...
	List<ProcessoVinculadoDocumentoDto> buscarProcessosVinculadosDocumento(
	...
	List<ProcessoDocumentosAtoProcessoDto> buscarDocumentosAtoProcesso(
			@RequestHeader("Authorization") String bearerToken,
			@PathVariable String idProcessoEdocs,
