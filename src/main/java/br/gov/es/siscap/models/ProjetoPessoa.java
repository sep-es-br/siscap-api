...
public class ProjetoPessoa extends ControleHistorico {
	...
	public ProjetoPessoa(Projeto projeto, Long idResponsavelProponente) {
		...
		this.setTipoPapel(new TipoPapel(PapelEnum.RESPONSAVEL_PROPONENTE.getValue()));
		this.setTipoEquipe(new TipoEquipe(EquipeEnum.ELABORACAO.getValue()));
	...
	public boolean isResponsavelProponente() {
		return Objects.equals(this.getTipoPapel().getId(), PapelEnum.RESPONSAVEL_PROPONENTE.getValue());
	}
