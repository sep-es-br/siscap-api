...
public abstract class EnvioAvisoPedidoParecerGerenciaSubcapEmailBuilder {

	/*
	 * Prezado(a) Gestor(a) da GEOC – Gerência de Operação de Crédito,

		Comunicamos que há um DIC (Documento Inicial para Captação) disponível para emissão de parecer.

		Acesse o sistema SISCAP em:
	 */

	private static final String CAMPO_APRESENTACAO = "Prezado(a) Gestor(a) da <strong>GEOC - Gerência de Operação de Crédito</strong>";
	private static final String CAMPO_CORPO = "Comunicamos que há um <strong>DIC (Documento Inicial para Captação)</strong> disponível para <strong>emissão de parecer</strong>.";
			
	public static String montarAssuntoEmail(String descricaoProjeto) {
		return "Pedido parecer gerencial SUBCAP DIC " + descricaoProjeto + ".";
	}
	
	public static String montarCorpoEmail( String linkEdicao ) {

		String campoTable = montarElementoTable( linkEdicao );
	...
	private static String montarElementoTable(String linkEdicao) {
		...
		String campoTratamento = String.format(CAMPO_APRESENTACAO);
		String campoCorpoPrincipal = String.format(CAMPO_CORPO) ;
		String linkAcessarDic = "<p style=\"font-size: 14px; color: #000000; margin-bottom: 5px;\">Acesse o sistema SISCAP em:</p> <a href=\"" + linkEdicao + "\" style=\"display: inline-block; padding: 10px 15px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 1px 0 1px 0; color: #2a8fbd;\"> " + linkEdicao + "</a>";
		...
		// return "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"background-color: #f5f5f5;\">  <tr>  <td align=\"center\" style=\"padding: 20px 0;\">  <table width=\"800\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"background-color: #ffffff; border-radius: 4px; box-shadow: 0 2px 4px #ffffff; max-width: 100%;\"> " + cabecalhoSuperior + " <tr><td style=\"padding: 0 12px;\"><hr style=\"border: 0; height: 0px; background-color: #e0e0e0; margin: 15px 0;\"></td></tr> <tr> <td style=\"padding: 15px 20px; width:90%; background-color: #fcea8f; font-size: 14px;\"><strong style=\"color: #d32f2f;\">Atenção:</strong> Este é um e-mail automático. Favor não responder.</td></tr>   <tr><td style=\"padding: 0 20px;\"><hr style=\"border: 0; height: 0px; background-color: #e0e0e0; margin: 15px 0;\"></td></tr> <tr><td style=\"padding: 0 20px 20px 20px;\"> <p style=\"font-size: 14px; line-height: 1.5; margin-bottom: 20px;\"> " + campoTratamento + ", </p> <p style=\"font-size: 14px; line-height: 1.5; margin-bottom: 20px;\"> " + campoCorpoPrincipal + "</p> </td> </tr> <td style=\"padding: 0 20px 20px 20px;\"> <p style=\"font-size: 14px; line-height: 1.5; margin-bottom: 20px;\">Em caso de dúvidas, estamos à disposição para prestar o suporte necessário.</p> </td> <tr><td style=\"padding: 15px 20px; background-color: #2a8fbd; text-align: center; font-size: 12px; color: #ffffff;\">©2025 - Desenvolvido pela CGTI-SEP <img src=\"cid:Icon-siscap\" style=\"height: 15px; vertical-align: middle; margin-right: 10px;\"> </td> </tr> </table> </td> </tr> </table>" ;
