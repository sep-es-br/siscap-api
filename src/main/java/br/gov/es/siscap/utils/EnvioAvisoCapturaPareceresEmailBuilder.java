...
public abstract class EnvioAvisoCapturaPareceresEmailBuilder {
	
	public static String montarAssuntoEmail() {
		return "DIC disponível para análise após pareceres.";
	}
	...
	private static String montarElementoTable(EnvioEmailDicDetalhesDto envioDetalhesDto) {
		...
		String campoTratamento = "Prezado(a)s";
		String campoCorpoPrincipal = "Os pareceres Orçamentário e Estratégico do DIC já foram capturados, e o processo pode seguir para a próxima fase de análise.";
