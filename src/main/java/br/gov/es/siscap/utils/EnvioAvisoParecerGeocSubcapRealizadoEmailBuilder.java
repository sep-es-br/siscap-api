...
public abstract class EnvioAvisoParecerGeocSubcapRealizadoEmailBuilder {

	private static final String CAMPO_APRESENTACAO = "Prezado(a) Subsecretário(a) da <strong>SUBCAP</strong>";
	private static final String CAMPO_CORPO = "Comunicamos que há um <strong>DIC (Documento Inicial para Captação)</strong> disponível para <strong>fazer parte de programa para captação</strong>.";
			
	public static String montarAssuntoEmail(String descricaoProjeto) {
		return "Parecer gerencial SUBCAP realizado DIC  " + descricaoProjeto + ".";
	}
