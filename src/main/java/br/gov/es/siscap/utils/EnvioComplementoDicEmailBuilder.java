...
public abstract class EnvioComplementoDicEmailBuilder {
	...
	private static String montarElementoTable(String nomeResponsavelEnvioEmail, Map<String,String> complemetacoes, String descricaoProjeto, String nomeGestorResponsavel) {
		...
		String pontosSeremComplementados = "<p style=\"font-size: 14px; color: #000000; margin-bottom: 5px;\">" + CAMPO_TITULO_COMPLEMENTACAO + " </p> <br> <p style=\"font-size: 14px; color: #000000; margin-bottom: 5px;\" > " + complemetacoes + " </p> "; 
