...
public abstract class EnvioAvisoSubcapDicAutuadoEmailBuilder {

	private static final String CAMPO_APRESENTACAO = "Prezado(a) Gestor(a) da <strong>SUBCAP - SUBSECRET DE EST CAPTACAO DE RECURSOS</strong>";
	private static final String CAMPO_CORPO = "Comunicamos que há um <strong>DIC (Documento Inicial para Captação)</strong> disponível para <strong>análise</strong>.";
			
	public static String montarAssuntoEmail(String descricaoProjeto) {
		return "DIC para análise. " + descricaoProjeto + ".";
	}
