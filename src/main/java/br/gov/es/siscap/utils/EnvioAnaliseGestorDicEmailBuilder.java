...
public abstract class EnvioAnaliseGestorDicEmailBuilder {
	...
	private static String montarElementoTable(EnvioEmailDicDetalhesDto envioDetalhesDto) {
		...
		String campoTratamento = "Prezada(o) Gestora(or) do(a) <strong>" + envioDetalhesDto.descricaoOrganizacaoGestor() + "</strong>";
		String campoCorpoPrincipal = "Informamos que há um DIC (Documento Inicial para Captação) disponível para análise e tramitação diretamente no SISCAP.<br><br>" +
